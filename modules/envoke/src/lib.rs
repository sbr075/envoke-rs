...
//! </br>
//!
//! Field can also be validated before and/or after parsing. Note that if you do
//! not specify where the validation should occur; before or after parsing. It
//! will automatically be called after parsing. Both cases can be seen in the
//! example below
//!
//! ```rust
